...
pathToFastq1= ?? # look in /shared/projects/training/test_fastq to get the path to the R1 fastq.gz file
pathToFastq2= ?? # look in /shared/projects/training/test_fastq to get the path to the R2 fastq.gz file
